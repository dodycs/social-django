...
urlpatterns = [
    ...
    path('user/settings/', views.user_setting, name='user_setting'),
    path('user/settings/update_information', views.update_information, name='update_information'),
    path('user/settings/update_password', views.update_password, name='update_password'),
